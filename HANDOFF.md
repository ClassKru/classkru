...
- Asset version ปัจจุบัน: `411`
- งานล่าสุด: คะแนนเต็มของ **ตัวชี้วัดรายวิชา** กำหนดเองได้ ส่วนคะแนนที่ได้ปัจจุบันคำนวณตามผลคะแนนและสัดส่วนคะแนนเต็มของงานที่เชื่อม โดยหน้าจอไม่ใช้คำว่า “คะแนนเฉลี่ย”
