...
- ข้อมูล Cloud ยังคงเป็น JSON ก้อนเดียวใน `classmanager_profiles.state`; หลังติดตั้ง `202608240002_json_patch_rpc.sql` แอปจะส่งเฉพาะ operation ของช่องที่เปลี่ยน และ PostgreSQL แก้ JSON ล่าสุดภายใต้ row lock
- รายการที่บันทึกไม่สำเร็จจะค้างใน IndexedDB แยกตามบัญชีและลองใหม่ตามลำดับเมื่อออนไลน์
