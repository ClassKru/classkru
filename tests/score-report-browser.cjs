...
(async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('.score-report-tab').count(),4);
    await page.locator('.score-report-tab[data-tab="students"]').click();
    ...
    await page.locator('.score-report-tab[data-tab="overview"]').click();
    await page.locator('.score-report-tab[data-tab="submission"]').click();
