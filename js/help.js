const HELP_DETAILS = {
  ...
  contact: { icon: 'hgi-message-02', title: 'ติดต่อทีมงาน', intro: 'มีคำถามหรืออยากให้ช่วยดูการใช้งาน ส่งข้อความหาเราได้เลย', tips: ['พิมพ์คำถามหรือรายละเอียดที่ต้องการให้ช่วย', 'แนบภาพหน้าจอได้เมื่อจำเป็น', 'ทีมงานจะตอบกลับโดยเร็วที่สุด'] }
};
...
const PUBLIC_HELP_DETAILS = {
  ...
  contact: { title: 'ติดต่อทีมงาน', intro: 'มีคำถามเกี่ยวกับการใช้งาน ส่งข้อความหาเราได้เลย', items: ['บอกสิ่งที่ต้องการให้ช่วยอย่างสั้น ๆ', 'แนบภาพหน้าจอได้เมื่อจำเป็น', 'ทีมงานจะตอบกลับโดยเร็วที่สุด'] }
};
